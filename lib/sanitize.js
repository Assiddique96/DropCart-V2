 ...
 */
export function sanitizeStoreInput({ name, username, description, email, contact, address, shippingLocalFee, shippingNationwideFee, shippingAbroadFee, shippingFreeAbove } = {}) {
  const errors = [];
