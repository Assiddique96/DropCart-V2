...
export function sanitizeProductInput({ name, description, mrp, price, category, sku, tags, scheduledAt, origin, acceptCod, madeIn, manufacturer, material, guaranteePeriod, deliveryWithinState, deliveryNationwide, deliveryInternational }) {
  ...
  const cleanDeliveryWithinState = parseBooleanField(deliveryWithinState);
  const cleanDeliveryNationwide = parseBooleanField(deliveryNationwide);
  const cleanDeliveryInternational = parseBooleanField(deliveryInternational);
