...
const StoreSidebar = ({storeInfo, stores = [], onStoreChange}) => {
  ...
  return (
    <div className="inline-flex h-full min-h-0 flex-col gap-5 border-r border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 sm:min-w-60">
      ...
      <div className="flex-1 overflow-y-auto max-sm:mt-6">
        {
