    ...
    return (
        <div className="flex items-center justify-between px-6 sm:px-12 py-3 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 transition-all">
            <Link href="/" className="relative text-4xl font-semibold text-slate-700">
                <span className="text-gray-600 dark:text-slate-200">Shp</span>
                <span className="text-gray-600 dark:text-slate-200">inx</span>
                <span className="text-gray-300 dark:text-slate-400 text-5xl leading-0">.</span>
