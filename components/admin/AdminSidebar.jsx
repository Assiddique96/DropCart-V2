...
import { HomeIcon, ShieldCheckIcon, StoreIcon, TicketPercentIcon, UsersIcon, CircleDollarSignIcon, SettingsIcon, RotateCcwIcon, ShoppingBasketIcon, ChevronUpIcon, ChevronDownIcon } from "lucide-react"
    ...
    return (
        <div className="relative inline-flex h-full min-h-0 flex-col border-r border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-950 sm:min-w-60">
            ...
            <div className="absolute right-3 top-3 flex flex-col gap-2">
                <button type="button" onClick={() => scrollSidebar(-180)}
