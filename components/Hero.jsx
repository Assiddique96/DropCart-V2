  ...
  return (
    <section className="mx-3 sm:mx-4 md:mx-6">
      ...
      <div className="mx-auto mt-4 flex max-w-7xl gap-4 lg:gap-6 xl:gap-8 max-xl:flex-col">
        <div className="group relative flex flex-1 flex-col overflow-hidden rounded-3xl bg-black/5 dark:bg-black/40 border border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500 transition-all duration-300">
          <div
          ...
          {featuredSlides.length > 1 && (
            <>
              <button
                ...
                className="absolute left-2 top-1/2 z-20 hidden -translate-y-1/2 rounded-full bg-black/60 p-2 text-white hover:bg-black/80 lg:flex border border-slate-500"
              >
              ...
              <button
                ...
                className="absolute right-2 top-1/2 z-20 hidden -translate-y-1/2 rounded-full bg-black/60 p-2 text-white hover:bg-black/80 lg:flex border border-slate-500"
              >
...
function PromoCarousel({ slides, index, setIndex }) {
  ...
  return (
    <aside className="relative flex w-full flex-1 min-h-[180px] overflow-hidden rounded-3xl bg-black/5 dark:bg-black/40 border border-slate-300 dark:border-slate-600 hover:border-slate-400 dark:hover:border-slate-500 transition-all duration-300">
      <Link
      ...
      <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
        {stores.map((v) => (
          <Link
            key={v.id}
            href={v.href}
            className="group flex flex-col justify-between rounded-2xl bg-white dark:bg-slate-800 p-3 text-slate-800 dark:text-slate-200 transition hover:-translate-y-0.5 ring-1 ring-slate-100 dark:ring-slate-600 hover:ring-slate-900 dark:hover:ring-slate-500"
          >
