                                ...
                                return (
                                    <div key={status}>
                                        <div className="flex justify-between text-xs mb-1">
                                            <span className="text-slate-600 dark:text-slate-300">{status.replace('_', ' ')}</span>
                        ...
                        <div className="space-y-3">
                            {data.topProducts.map((p, i) => (
                                <div key={p.productId} className="flex items-center gap-3 cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 rounded-lg p-1.5 transition"
                                    ...
                                    <p className="text-xs font-semibold text-slate-600 dark:text-slate-300 shrink-0">{currency}{p.price.toLocaleString()}</p>
                                </div>
                            ))}
                        </div>
                    </div>
