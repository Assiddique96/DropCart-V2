export const metadata = {
  title: "FAQs — Shpinx",
  description:
    "Frequently asked questions about shopping, orders, payments, returns, and store accounts on Sphinx.",
};
      ...
      <div className="mx-auto my-16 max-w-4xl">
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 mx-auto max-w-xl text-sm text-slate-500 dark:text-slate-300">
            Quick answers to common questions about Shpinx. If you can’t find
            what you need, please reach out via our Contact page.
          </p>
        </div>
        ...
        <div className="space-y-4">
          {FAQS.map((item) => (
            <details
              key={item.q}
              className="group rounded-xl border border-slate-200 bg-white p-5 transition dark:border-slate-700 dark:bg-slate-900"
            >
              <summary className="flex cursor-pointer list-none select-none items-start justify-between gap-4">
                <span className="font-medium text-slate-800 dark:text-white">
                  {item.q}
                </span>
                <span className="text-slate-400 transition group-open:rotate-180 dark:text-slate-500">
                  ▾
                </span>
              </summary>
