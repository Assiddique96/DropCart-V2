        ...
        <div className="min-h-[70vh] mx-6 mb-24">
            <div className="max-w-5xl mx-auto my-16">
                <div className="text-center mb-12">
                    <h1 className="text-3xl font-semibold text-slate-800">Get in <span className="text-green-500">Touch</span></h1>
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    {/* Info */}
                    <div>
                        <h2 className="text-lg font-medium text-slate-700 mb-6">Contact Information</h2>
                        <div className="space-y-5 text-slate-500 text-sm">
                            {[
                                ...
                                <div key={label} className="flex items-start gap-4">
                                    <div className="p-2.5 rounded-full bg-slate-100 text-slate-600 mt-0.5">
                                        <Icon size={16} />
                                    </div>
                                    <div>
                        ...
                        <div className="mt-10 p-5 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-500">
                            <p className="font-medium text-slate-700 mb-1">Support hours</p>
                            <p>Monday – Friday: 9am – 6pm WAT</p>
                            <p>Saturday: 10am – 2pm WAT</p>
                            <p className="mt-2 text-xs text-slate-400">We typically respond within 24 hours.</p>
                        </div>
                    </div>
