      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between my-8">
          ...
          {wishlistProducts.length > 0 && (
            <button
              ...
              className="px-5 py-2 bg-slate-800 text-white text-sm rounded-lg hover:bg-slate-900 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white transition"
            >
              Add All to Cart
            </button>
          )}
        ...
        {wishlistProducts.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-24 text-slate-400 dark:text-slate-500">
            <HeartIcon
              size={48}
              className="mb-4 opacity-20 text-slate-400 dark:text-slate-500"
            />
            ...
            <Link
              href="/shop"
              className="px-6 py-2.5 bg-slate-800 text-white rounded-lg text-sm hover:bg-slate-900 dark:bg-slate-100 dark:text-slate-900 dark:hover:bg-white transition"
            >
              Browse Products
            </Link>
          </div>
